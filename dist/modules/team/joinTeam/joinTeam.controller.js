...
const createJoinTeam = (0, catchAsync_1.default)(async (req, res) => {
  ...
  const result = await joinTeam_service_1.JoinTeamService.createJoinTeam(
    createTeam
  );
...
const getSingleJoinTeam = (0, catchAsync_1.default)(async (req, res) => {
  ...
  const result = await joinTeam_service_1.JoinTeamService.getSingleJoinTeam(
    email
  );
  (0, sendResponse_1.default)(res, {
    success: true,
...
const updateSingleJoinTeam = (0, catchAsync_1.default)(async (req, res) => {
  ...
  const result = await joinTeam_service_1.JoinTeamService.updateSingleJoinTeam(
    id,
    updateData
  );
  (0, sendResponse_1.default)(res, {
...
const deleteSingleJoinTeam = (0, catchAsync_1.default)(async (req, res) => {
  ...
  const result = await joinTeam_service_1.JoinTeamService.deleteSingleJoinTeam(
    id
  );
