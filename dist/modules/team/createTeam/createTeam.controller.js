...
const createTeam = (0, catchAsync_1.default)(async (req, res) => {
  ...
  const result = await createTeam_service_1.CreateTeamService.createTeam(
    createTeam
  );
...
const getSingleTeamByEmail = (0, catchAsync_1.default)(async (req, res) => {
  ...
  const result =
    await createTeam_service_1.CreateTeamService.getSingleTeamByEmail(email);
  (0, sendResponse_1.default)(res, {
    success: true,
    statusCode: http_status_1.default.OK,
...
const getSingleTeamById = (0, catchAsync_1.default)(async (req, res) => {
  ...
  const result = await createTeam_service_1.CreateTeamService.getSingleTeamById(
    id
  );
  (0, sendResponse_1.default)(res, {
    success: true,
...
const updateSingleTeam = (0, catchAsync_1.default)(async (req, res) => {
  ...
  const result = await createTeam_service_1.CreateTeamService.updateSingleTeam(
    id,
    updateData
  );
  (0, sendResponse_1.default)(res, {
...
const acceptTeam = (0, catchAsync_1.default)(async (req, res) => {
  const id = req.params.id;
  const updateData = req.body;
  const result = await createTeam_service_1.CreateTeamService.acceptTeam(
    id,
    updateData
  );
  (0, sendResponse_1.default)(res, {
...
const deleteSingleTeam = (0, catchAsync_1.default)(async (req, res) => {
  const id = req.params.id;

  const result = await createTeam_service_1.CreateTeamService.deleteSingleTeam(
    id
  );
