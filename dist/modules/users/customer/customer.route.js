...
router.post("/signUp", multer_1.multerUpload.single("profileImage"), (0, roleCheck_1.default)(user_1.ENUM_USER_ROLE.CUSTOMER), (0, validateRequest_1.default)(users_validation_1.AuthValidation.signUpZodSchema), users_controller_1.UserController.createUser);
